...
class SEResNet50Network(network_base.BaseNetwork):
    def setup(self):
        ...
        (self.feed('image')
             ...
             # conv2 x 3
             .sext_bottleneck_block(128, is_training, 32, data_format, True, True   ,name='conv2_1')
             .sext_bottleneck_block(128, is_training, 32, data_format, False, False ,name='conv2_2')
             .sext_bottleneck_block(128, is_training, 32, data_format, False, False ,name='conv2_3')
             # conv3 x 4                                                                      
             .sext_bottleneck_block(256, is_training, 32, data_format, True, True   ,name='conv3_1')
             .sext_bottleneck_block(256, is_training, 32, data_format, False, False ,name='conv3_2')
             .sext_bottleneck_block(256, is_training, 32, data_format, False, False ,name='conv3_3')
             .sext_bottleneck_block(256, is_training, 32, data_format, False, False ,name='conv3_4')
             # conv4 x 6                                                                      
             .sext_bottleneck_block(512, is_training, 32, data_format, True, True   ,name='conv4_1')
             .sext_bottleneck_block(512, is_training, 32, data_format, False, False ,name='conv4_2')
             .sext_bottleneck_block(512, is_training, 32, data_format, False, False ,name='conv4_3')
             .sext_bottleneck_block(512, is_training, 32, data_format, False, False ,name='conv4_4')
             .sext_bottleneck_block(512, is_training, 32, data_format, False, False ,name='conv4_5')
             .sext_bottleneck_block(512, is_training, 32, data_format, False, False ,name='conv4_6')
             # conv5 x 3                                                                      
             .sext_bottleneck_block(1024, is_training, 32, data_format, True, True  , name='conv5_1')
             .sext_bottleneck_block(1024, is_training, 32, data_format, False, False, name='conv5_2')
             .sext_bottleneck_block(1024, is_training, 32, data_format, False, False, name='conv5_3'))
